  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__goOu1)}>
            <div
          ...
          <div className={classNames(projectcss.all, sty.column__lsBn5)}>
            <div
              ...
              >
                <CommonComponentsButton
                  ...
                  color={undefined}
                    ...
                    <Icon4Icon
                      className={classNames(projectcss.all, sty.svg__rzSdo)}
                      role={"img"}
                    />
                  }
                  iconEnd={true}
...
const PlasmicDescendants = {
  ...
  freeBox: ["freeBox", "commonComponentsButton"],
  commonComponentsButton: ["commonComponentsButton"]
} as const;
