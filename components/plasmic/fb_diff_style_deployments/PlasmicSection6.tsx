...
import sty from "./PlasmicSection6.module.css"; // plasmic-import: VNb8XA3kzXU5/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__eaBMu)}>
            <div
          ...
          <div className={classNames(projectcss.all, sty.column___4Gdfb)}>
            <div
