...
import CommonComponentsButton from "../../CommonComponentsButton"; // plasmic-import: lee2PYdlZL7u/component
...
import sty from "./PlasmicSection3.module.css"; // plasmic-import: 2EluddZ_DQqK/css
...
export type PlasmicSection3__OverridesType = {
  ...
  commonComponentsButton?: Flex__<typeof CommonComponentsButton>;
  svg?: Flex__<"svg">;
...
function PlasmicSection3__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__iIJch)}>
          <div className={classNames(projectcss.all, sty.freeBox__ljSD)}>
            <div
              data-plasmic-name={"columns"}
              data-plasmic-override={overrides.columns}
              className={classNames(projectcss.all, sty.columns)}
            >
              <div className={classNames(projectcss.all, sty.column__t73CE)}>
                <div
                  className={classNames(projectcss.all, sty.freeBox___6HCjW)}
                >
                  <h2
                ...
                <CommonComponentsButton
                  data-plasmic-name={"commonComponentsButton"}
                  data-plasmic-override={overrides.commonComponentsButton}
                  className={classNames(
                    "__wab_instance",
                    sty.commonComponentsButton
                  )}
                  color={undefined}
                  end={
                    <Icon4Icon
              ...
              <div className={classNames(projectcss.all, sty.column__kiFWl)}>
                <div
                ...
                >
                  <PlasmicImg__
                    ...
                    loading={"lazy"}
                    src={{
                      src: "/plasmic/fb_diff_style_deployments/images/image.png",
                      fullWidth: 1600,
                      fullHeight: 1200,
...
const PlasmicDescendants = {
  ...
  commonComponentsButton: ["commonComponentsButton", "svg"],
  svg: ["svg"],
...
type NodeDefaultElementType = {
  ...
  listIteam7: "li";
  listIteam8: "li";
  commonComponentsButton: typeof CommonComponentsButton;
  svg: "svg";
  bannerImage2: "div";
...
export const PlasmicSection3 = Object.assign(
  ...
  makeNodeComponent("section3"),
  {
    ...
    commonComponentsButton: makeNodeComponent("commonComponentsButton"),
