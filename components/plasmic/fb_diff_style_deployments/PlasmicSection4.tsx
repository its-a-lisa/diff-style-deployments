...
import sty from "./PlasmicSection4.module.css"; // plasmic-import: 1QFNANrxW-un/css
...
function PlasmicSection4__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__puItI)}>
        <div
          data-plasmic-name={"columns"}
          data-plasmic-override={overrides.columns}
          className={classNames(projectcss.all, sty.columns)}
        >
          <div className={classNames(projectcss.all, sty.column___3Vzg)}>
            <PlasmicImg__
              ...
              loading={"lazy"}
              src={{
                src: "/plasmic/fb_diff_style_deployments/images/image7.png",
                fullWidth: 1112,
                fullHeight: 794,
          ...
          <div className={classNames(projectcss.all, sty.column__aku5)}>
            <div className={classNames(projectcss.all, sty.freeBox__wrZce)}>
              <h2
