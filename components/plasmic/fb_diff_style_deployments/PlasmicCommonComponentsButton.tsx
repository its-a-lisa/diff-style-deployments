...
import sty from "./PlasmicCommonComponentsButton.module.css"; // plasmic-import: lee2PYdlZL7u/css

import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: qvXrEMvH6wcF/icon
import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: QmGx3FWbynST/icon

createPlasmicElementProxy;

export type PlasmicCommonComponentsButton__VariantMembers = {
...
export type PlasmicCommonComponentsButton__VariantsArgs = {
...
type VariantPropType = keyof PlasmicCommonComponentsButton__VariantsArgs;
export const PlasmicCommonComponentsButton__VariantProps =
...
export type PlasmicCommonComponentsButton__ArgsType = {
  disabled?: boolean;
  submitsForm?: boolean;
  resetsForm?: boolean;
  ariaLabel?: string;
...
type ArgPropType = keyof PlasmicCommonComponentsButton__ArgsType;
export const PlasmicCommonComponentsButton__ArgProps = new Array<ArgPropType>(
  "disabled",
  "submitsForm",
  "resetsForm",
  "ariaLabel",
...
export type PlasmicCommonComponentsButton__OverridesType = {
...
export interface DefaultCommonComponentsButtonProps {
  disabled?: boolean;
  submitsForm?: boolean;
  resetsForm?: boolean;
  ariaLabel?: string;
...
function PlasmicCommonComponentsButton__RenderFunc(props: {
  variants: PlasmicCommonComponentsButton__VariantsArgs;
  args: PlasmicCommonComponentsButton__ArgsType;
  overrides: PlasmicCommonComponentsButton__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__jd6L1, {
          [sty.freeBoxcolor_neutral__jd6L1Y8IPu]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxroundedFull__jd6L1L3Ak8]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__jd6L1FF3P]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__jd6L11Pxcr]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__jd6L1BoAhc]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__jd6L1FCphN]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__jd6L1DPaL5]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_success__jd6L1DPaL5QQfS]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__ohxXj, {
            [sty.freeBoxcolor_neutral__ohxXjy8IPu]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart__ohxXjgPn27]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__ohxXjFF3P]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__ohxXjBoAhc]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__ohxXjfCphN]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__ohxXjDPaL5]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral__ohxXj1D2GyY8IPu]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__t3KLt)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__aIkU, {
            [sty.freeBoxiconEnd__aIkUKsBPg]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__aIkUFF3P]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__aIkUBoAhc]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__aIkUfCphN]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__yBcr8)}
                role={"img"}
              />
            ),
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicCommonComponentsButton__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicCommonComponentsButton__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicCommonComponentsButton__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicCommonComponentsButton__ArgProps,
          internalVariantPropNames: PlasmicCommonComponentsButton__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicCommonComponentsButton__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicCommonComponentsButton";
  } else {
    func.displayName = `PlasmicCommonComponentsButton.${nodeName}`;
  }
  return func;
}

export const PlasmicCommonComponentsButton = Object.assign(
  // Top-level PlasmicCommonComponentsButton renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicCommonComponentsButton
    internalVariantProps: PlasmicCommonComponentsButton__VariantProps,
    internalArgProps: PlasmicCommonComponentsButton__ArgProps
  }
);

export default PlasmicCommonComponentsButton;
/* prettier-ignore-end */
