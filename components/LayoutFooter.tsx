...
} from "./plasmic/fb_diff_style_deployments/PlasmicLayoutFooter";
...
function LayoutFooter_(
  props: LayoutFooterProps,
  ref: HTMLElementRefOf<"footer">
) {
  ...
  return <PlasmicLayoutFooter footer={{ ref }} {...props} />;
}
